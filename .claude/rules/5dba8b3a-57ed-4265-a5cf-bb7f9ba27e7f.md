<rule_activation id="5dba8b3a-57ed-4265-a5cf-bb7f9ba27e7f" title="Adopt Quality Gates Pattern for Domain Service Layer Validation: Domain Service Methods" applies_to="**/app/Domains/**/*.php">
...
<enforcement>
Claude Code MUST verify quality gate implementation for all service methods accepting external input. Verification includes:
- Code review checklist verification of quality gate implementation
- Static analysis to detect service methods lacking validation logic
- Unit test coverage for validation failure scenarios
...
Claude Code MUST NOT skip or defer verification of quality gates at service boundaries.
</enforcement>