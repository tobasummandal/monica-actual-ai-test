...
- **R-CICD-SEC-001** MUST: Pipeline logs MUST NOT expose secret values in output, error messages, or debug information.
...
# Count files with secrets management references
...
<enforcement>
Claude Code MUST verify pipeline configurations do not expose secrets in logs. Verification MUST NOT be skipped or deferred.
</enforcement>