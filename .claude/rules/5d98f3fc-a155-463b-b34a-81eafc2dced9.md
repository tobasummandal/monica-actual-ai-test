<rule_activation id="5d98f3fc-a155-463b-b34a-81eafc2dced9" title="Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Database Backed Domain" applies_to="**/*">
...
- **R-ELQ-001** MUST: All database-backed domain entities MUST be represented as Eloquent Model classes extending Illuminate\Database\Eloquent\Model.
...
- **R-ELQ-002** MUST: Place all model classes in app/Models directory with singular, PascalCase naming (e.g., User, PostTemplateSection, ContactInformationType).
...
# Find models that don't use the Eloquent Model class
...
<enforcement>
Claude Code MUST verify compliance with these rules when creating or modifying model classes. Verification MUST NOT be skipped or deferred.
