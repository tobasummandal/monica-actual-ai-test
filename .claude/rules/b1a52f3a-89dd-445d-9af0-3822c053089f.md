<rule_activation id="b1a52f3a-89dd-445d-9af0-3822c053089f" title="Adopt Eloquent ORM Models as Standard Data Access Layer: Model Specific Business" applies_to="**/*">
...
- **R-ELOQUENT-001** SHOULD: Model-specific business logic and computed attributes SHOULD be encapsulated within the model class using accessors, mutators, and custom methods.
