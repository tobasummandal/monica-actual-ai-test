# Standardize Laravel Fortify for Authentication Runtime: Password Validation Hashing
...
1. MUST: Password validation and hashing MUST be handled exclusively by Fortify's built-in mechanisms

## Policy Block

- MUST Password validation and hashing MUST be handled exclusively by Fortify's built-in mechanisms
