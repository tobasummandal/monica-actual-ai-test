...
1. SHOULD: Domain boundaries SHOULD align with business capabilities and use cases rather than technical layers

## Policy Block

- SHOULD Domain boundaries SHOULD align with business capabilities and use cases rather than technical layers
