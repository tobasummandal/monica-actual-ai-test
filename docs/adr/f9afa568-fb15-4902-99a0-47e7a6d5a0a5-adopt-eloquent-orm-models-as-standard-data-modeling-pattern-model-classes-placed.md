...
1. MUST: Model classes MUST be placed in the app/Models directory following Laravel namespace conventions

## Policy Block

- MUST Model classes MUST be placed in the app/Models directory following Laravel namespace conventions
