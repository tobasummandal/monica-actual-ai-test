...
1. MUST: Event subscription MUST use the emitter.on() method to register event handlers for cross-component communication

## Policy Block

- MUST Event subscription MUST use the emitter.on() method to register event handlers for cross-component communication
