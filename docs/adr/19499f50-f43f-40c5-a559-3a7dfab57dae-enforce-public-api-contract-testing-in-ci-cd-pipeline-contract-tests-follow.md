# Enforce Public API Contract Testing in CI/CD Pipeline: Contract Tests Follow
...
1. SHOULD: API contract tests SHOULD follow naming conventions that clearly identify the component under test (e.g., *ControllerTest.php, *ServiceTest.php, *ViewHelperTest.php)

## Policy Block

- SHOULD API contract tests SHOULD follow naming conventions that clearly identify the component under test (e.g., *ControllerTest.php, *ServiceTest.php, *ViewHelperTest.php)
