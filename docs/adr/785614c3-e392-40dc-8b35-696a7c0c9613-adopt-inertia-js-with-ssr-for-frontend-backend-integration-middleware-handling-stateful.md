...
1. SHOULD: Middleware handling stateful requests SHOULD extend or integrate with Inertia's HandleInertiaRequests middleware to maintain consistent request/response patterns

## Policy Block

- SHOULD Middleware handling stateful requests SHOULD extend or integrate with Inertia's HandleInertiaRequests middleware to maintain consistent request/response patterns
