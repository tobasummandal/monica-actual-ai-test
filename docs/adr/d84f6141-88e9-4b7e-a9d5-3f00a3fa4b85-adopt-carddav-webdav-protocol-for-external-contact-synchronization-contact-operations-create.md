...
1. MUST: Contact operations (create, update, delete) with external systems MUST use structured DTOs (ContactDto, ContactDeleteDto) to encapsulate data transfer

## Policy Block

- MUST Contact operations (create, update, delete) with external systems MUST use structured DTOs (ContactDto, ContactDeleteDto) to encapsulate data transfer
