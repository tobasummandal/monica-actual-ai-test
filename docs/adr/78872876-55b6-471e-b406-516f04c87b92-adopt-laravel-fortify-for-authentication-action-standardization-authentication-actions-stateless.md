...
1. SHOULD: Authentication actions SHOULD be stateless and idempotent where possible to support horizontal scaling and API-first deployment patterns

## Policy Block

- SHOULD Authentication actions SHOULD be stateless and idempotent where possible to support horizontal scaling and API-first deployment patterns
