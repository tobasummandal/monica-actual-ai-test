...
1. MUST: All password storage operations MUST use Hash::make() to generate bcrypt hashes before persisting to the database

## Policy Block

- MUST All password storage operations MUST use Hash::make() to generate bcrypt hashes before persisting to the database
