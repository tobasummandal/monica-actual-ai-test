...
1. MUST: Cross-component communication for UI notifications and state changes MUST use the event emitter pattern via tiny-emitter instance

## Policy Block

- MUST Cross-component communication for UI notifications and state changes MUST use the event emitter pattern via tiny-emitter instance
