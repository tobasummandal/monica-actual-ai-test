...
1. MUST: API controllers implementing pagination MUST respect the max_limit_per_page configuration value and return HTTP 400 with error code 30 when exceeded

## Policy Block

- MUST API controllers implementing pagination MUST respect the max_limit_per_page configuration value and return HTTP 400 with error code 30 when exceeded
