...
1. MUST: Unit tests MUST run before feature tests in the CI/CD pipeline to provide fast feedback

## Policy Block

- MUST Unit tests MUST run before feature tests in the CI/CD pipeline to provide fast feedback
