...
1. MUST: Model classes MUST be placed in the app/Models namespace following Laravel conventions

## Policy Block

- MUST Model classes MUST be placed in the app/Models namespace following Laravel conventions
