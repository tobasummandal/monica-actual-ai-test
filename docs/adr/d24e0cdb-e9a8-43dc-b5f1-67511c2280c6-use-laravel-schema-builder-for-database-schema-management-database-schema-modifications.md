...
1. MUST: All database schema modifications MUST be implemented using Laravel's Schema facade and Blueprint API within migration classes extending Illuminate\Database\Migrations\Migration

## Policy Block

- MUST All database schema modifications MUST be implemented using Laravel's Schema facade and Blueprint API within migration classes extending Illuminate\Database\Migrations\Migration
