...
1. MUST: All controller methods that access or modify domain resources MUST perform authorization checks before executing business logic

## Policy Block

- MUST All controller methods that access or modify domain resources MUST perform authorization checks before executing business logic
