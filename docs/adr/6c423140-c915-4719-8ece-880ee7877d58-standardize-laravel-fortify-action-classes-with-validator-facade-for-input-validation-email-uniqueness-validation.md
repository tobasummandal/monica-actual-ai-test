...
1. MUST: Email uniqueness validation MUST use Rule::unique() with appropriate ignore clauses for update operations

## Policy Block

- MUST Email uniqueness validation MUST use Rule::unique() with appropriate ignore clauses for update operations
