...
1. MUST: Console commands for application setup and initialization MUST be implemented in app/Console/Commands/ and follow the Command pattern

## Policy Block

- MUST Console commands for application setup and initialization MUST be implemented in app/Console/Commands/ and follow the Command pattern
