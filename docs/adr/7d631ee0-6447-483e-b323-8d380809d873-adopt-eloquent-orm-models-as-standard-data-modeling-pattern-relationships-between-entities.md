# Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Relationships Between Entities
...
1. SHOULD: Relationships between entities SHOULD be defined using Eloquent relationship methods (hasMany, belongsTo, belongsToMany, etc.)

## Policy Block

- SHOULD Relationships between entities SHOULD be defined using Eloquent relationship methods (hasMany, belongsTo, belongsToMany, etc.)
