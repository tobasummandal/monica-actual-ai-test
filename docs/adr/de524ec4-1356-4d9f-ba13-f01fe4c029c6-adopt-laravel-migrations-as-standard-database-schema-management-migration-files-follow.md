...
1. MUST: Migration files MUST follow Laravel's naming convention: YYYY_MM_DD_HHMMSS_descriptive_name.php with timestamps ensuring chronological execution order

## Policy Block

- MUST Migration files MUST follow Laravel's naming convention: YYYY_MM_DD_HHMMSS_descriptive_name.php with timestamps ensuring chronological execution order
