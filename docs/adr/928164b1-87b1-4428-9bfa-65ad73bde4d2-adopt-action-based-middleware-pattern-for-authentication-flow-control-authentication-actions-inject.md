...
1. MUST: Authentication actions MUST inject StatefulGuard and LoginRateLimiter dependencies via constructor to coordinate authentication state and rate limiting.

## Policy Block

- MUST Authentication actions MUST inject StatefulGuard and LoginRateLimiter dependencies via constructor to coordinate authentication state and rate limiting.
