# Standardize Primary Datastore Access Patterns in Domain Services and Helpers: Background Jobs That
...
1. MUST: Background jobs that access datastores MUST implement proper error handling and transaction management

## Policy Block

- MUST Background jobs that access datastores MUST implement proper error handling and transaction management
