# Use Laravel Hash Facade for Password Credential Storage: Password Verification Use
...
1. MUST: Password verification MUST use Hash::check() to compare plain-text input against stored hashes

## Policy Block

- MUST Password verification MUST use Hash::check() to compare plain-text input against stored hashes
