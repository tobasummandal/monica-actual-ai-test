...
1. MAY: Action classes MAY use tap() helper to chain user validation with failure event firing

## Policy Block

- MAY Action classes MAY use tap() helper to chain user validation with failure event firing
