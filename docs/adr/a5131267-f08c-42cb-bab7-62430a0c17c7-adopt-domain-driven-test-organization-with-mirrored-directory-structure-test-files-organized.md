# Adopt Domain-Driven Test Organization with Mirrored Directory Structure: Test Files Organized
...
1. MUST: Test files MUST be organized in a directory structure that mirrors the production code hierarchy, maintaining a 1:1 correspondence between test and implementation files

## Policy Block

- MUST Test files MUST be organized in a directory structure that mirrors the production code hierarchy, maintaining a 1:1 correspondence between test and implementation files
