...
1. MUST: Pipeline logs MUST NOT expose secret values in output, error messages, or debug information

## Policy Block

- MUST Pipeline logs MUST NOT expose secret values in output, error messages, or debug information
