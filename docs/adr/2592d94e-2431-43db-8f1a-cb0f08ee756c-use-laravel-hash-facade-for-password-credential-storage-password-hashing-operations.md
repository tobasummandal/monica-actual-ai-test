...
1. SHOULD: Password hashing operations SHOULD be performed immediately before database persistence to minimize plain-text exposure in memory

## Policy Block

- SHOULD Password hashing operations SHOULD be performed immediately before database persistence to minimize plain-text exposure in memory
