# Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Models Define Query
...
1. MAY: Models MAY define query scopes for reusable query logic specific to the entity
