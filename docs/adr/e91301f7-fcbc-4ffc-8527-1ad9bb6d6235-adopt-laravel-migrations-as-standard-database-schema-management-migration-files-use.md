...
1. MUST: Migration files MUST use Laravel's Schema Builder API (Schema::create, Schema::table, etc.) rather than raw SQL for database-agnostic operations

## Policy Block

- MUST Migration files MUST use Laravel's Schema Builder API (Schema::create, Schema::table, etc.) rather than raw SQL for database-agnostic operations
