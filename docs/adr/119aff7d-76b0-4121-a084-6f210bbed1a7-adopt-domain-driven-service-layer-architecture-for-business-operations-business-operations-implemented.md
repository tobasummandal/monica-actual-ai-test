# Adopt Domain-Driven Service Layer Architecture for Business Operations: Business Operations Implemented
...
1. MUST: Business operations MUST be implemented as dedicated service classes within domain-specific namespaces (e.g., app/Domains/{Domain}/{Feature}/Services/)

## Policy Block

- MUST Business operations MUST be implemented as dedicated service classes within domain-specific namespaces (e.g., app/Domains/{Domain}/{Feature}/Services/)
