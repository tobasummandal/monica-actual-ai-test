# Adopt HTTP Client Libraries for External API Integration: External Integrations Wrapped
...
1. SHOULD: External API integrations SHOULD be wrapped in service classes that encapsulate the HTTP client library usage

## Policy Block

- SHOULD External API integrations SHOULD be wrapped in service classes that encapsulate the HTTP client library usage
