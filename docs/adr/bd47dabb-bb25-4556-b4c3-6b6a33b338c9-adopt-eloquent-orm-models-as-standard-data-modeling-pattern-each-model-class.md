# Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Each Model Class
...
1. MUST: Each model class MUST correspond to a single database table following Laravel naming conventions (singular PascalCase class name to plural snake_case table name)

## Policy Block

- MUST Each model class MUST correspond to a single database table following Laravel naming conventions (singular PascalCase class name to plural snake_case table name)
