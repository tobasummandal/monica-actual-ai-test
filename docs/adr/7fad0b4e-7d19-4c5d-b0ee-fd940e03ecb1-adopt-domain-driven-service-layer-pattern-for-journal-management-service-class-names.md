# Adopt Domain-Driven Service Layer Pattern for Journal Management: Service Class Names
...
1. SHOULD: Service class names SHOULD use verb-noun naming convention that clearly describes the operation (e.g., RemoveContactFromPost, IncrementPostReadCounter)

## Policy Block

- SHOULD Service class names SHOULD use verb-noun naming convention that clearly describes the operation (e.g., RemoveContactFromPost, IncrementPostReadCounter)
