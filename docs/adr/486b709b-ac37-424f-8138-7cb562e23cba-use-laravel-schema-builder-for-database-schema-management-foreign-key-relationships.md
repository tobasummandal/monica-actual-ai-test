...
1. SHOULD: Foreign key relationships SHOULD use foreignIdFor() method with constrained() and cascadeOnDelete() for referential integrity

## Policy Block

- SHOULD Foreign key relationships SHOULD use foreignIdFor() method with constrained() and cascadeOnDelete() for referential integrity
