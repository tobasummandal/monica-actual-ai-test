# Adopt Inertia.js with SSR for Frontend-Backend Integration: Frontend Backend Integration
...
1. MUST: All frontend-backend integration MUST use Inertia.js as the primary communication layer between Laravel controllers and JavaScript components
