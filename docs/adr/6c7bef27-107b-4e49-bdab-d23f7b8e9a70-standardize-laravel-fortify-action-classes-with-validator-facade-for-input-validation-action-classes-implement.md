...
1. MAY: Action classes MAY implement additional business logic after validation passes but before persistence

## Policy Block

- MAY Action classes MAY implement additional business logic after validation passes but before persistence
