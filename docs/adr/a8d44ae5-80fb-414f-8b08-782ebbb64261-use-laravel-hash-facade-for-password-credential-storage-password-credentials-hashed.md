# Use Laravel Hash Facade for Password Credential Storage: Password Credentials Hashed
...
1. MUST: All password credentials MUST be hashed using Laravel's Hash facade before storage in the database

## Policy Block

- MUST All password credentials MUST be hashed using Laravel's Hash facade before storage in the database
