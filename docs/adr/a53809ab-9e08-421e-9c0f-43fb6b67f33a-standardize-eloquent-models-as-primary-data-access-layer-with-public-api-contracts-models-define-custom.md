# Standardize Eloquent Models as Primary Data Access Layer with Public API Contracts: Models Define Custom
...
1. MAY: Models MAY define custom query scopes to encapsulate common query patterns

## Policy Block

- MAY Models MAY define custom query scopes to encapsulate common query patterns
