...
1. SHOULD: Feature-gating middleware (e.g., EnsureSignupIsEnabled) SHOULD integrate with Inertia's response cycle to provide seamless redirects without breaking SPA navigation

## Policy Block

- SHOULD Feature-gating middleware (e.g., EnsureSignupIsEnabled) SHOULD integrate with Inertia's response cycle to provide seamless redirects without breaking SPA navigation
