...
1. SHOULD: Form submissions SHOULD return Inertia responses with appropriate redirect() or back() methods to maintain SPA navigation

## Policy Block

- SHOULD Form submissions SHOULD return Inertia responses with appropriate redirect() or back() methods to maintain SPA navigation
