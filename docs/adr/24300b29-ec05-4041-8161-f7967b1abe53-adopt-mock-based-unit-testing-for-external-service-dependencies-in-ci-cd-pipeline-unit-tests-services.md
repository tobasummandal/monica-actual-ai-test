...
1. MUST: Unit tests for services that interact with external APIs or network resources MUST use mocks, stubs, or fakes instead of real connections

## Policy Block

- MUST Unit tests for services that interact with external APIs or network resources MUST use mocks, stubs, or fakes instead of real connections
