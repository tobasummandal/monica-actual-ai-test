...
1. MAY: Validation MAY include custom after() callbacks for complex cross-field validation logic that cannot be expressed declaratively

## Policy Block

- MAY Validation MAY include custom after() callbacks for complex cross-field validation logic that cannot be expressed declaratively
