...
1. MUST: Authorization enforcement points MUST be implemented at the earliest possible boundary (controller entry point or service layer) to fail fast on unauthorized requests

## Policy Block

- MUST Authorization enforcement points MUST be implemented at the earliest possible boundary (controller entry point or service layer) to fail fast on unauthorized requests
