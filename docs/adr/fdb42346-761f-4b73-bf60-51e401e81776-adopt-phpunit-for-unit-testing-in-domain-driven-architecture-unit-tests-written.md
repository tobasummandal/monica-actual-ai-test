# Adopt PHPUnit for Unit Testing in Domain-Driven Architecture: Unit Tests Written
...
1. MUST: All unit tests MUST be written using PHPUnit as the testing framework

## Policy Block

- MUST All unit tests MUST be written using PHPUnit as the testing framework
