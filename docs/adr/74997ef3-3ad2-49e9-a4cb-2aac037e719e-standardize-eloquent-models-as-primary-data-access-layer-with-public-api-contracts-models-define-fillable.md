# Standardize Eloquent Models as Primary Data Access Layer with Public API Contracts: Models Define Fillable
...
1. SHOULD: Models SHOULD define $fillable or $guarded properties to control mass assignment protection

## Policy Block

- SHOULD Models SHOULD define $fillable or $guarded properties to control mass assignment protection
