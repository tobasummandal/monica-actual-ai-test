...
1. SHOULD: Import operations SHOULD provide separate resource handlers for generic DAV imports and vCard-specific imports

## Policy Block

- SHOULD Import operations SHOULD provide separate resource handlers for generic DAV imports and vCard-specific imports
