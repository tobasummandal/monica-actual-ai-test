...
1. MUST: Data transfer between external APIs and domain logic MUST use dedicated DTO (Data Transfer Object) classes located in Services/Utils/Model directories

## Policy Block

- MUST Data transfer between external APIs and domain logic MUST use dedicated DTO (Data Transfer Object) classes located in Services/Utils/Model directories
