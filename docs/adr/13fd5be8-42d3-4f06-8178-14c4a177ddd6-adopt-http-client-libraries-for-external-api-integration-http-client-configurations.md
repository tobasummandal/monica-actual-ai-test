# Adopt HTTP Client Libraries for External API Integration: Http Client Configurations
...
1. SHOULD: HTTP client configurations SHOULD be externalized to configuration files or environment variables for different environments

## Policy Block

- SHOULD HTTP client configurations SHOULD be externalized to configuration files or environment variables for different environments
