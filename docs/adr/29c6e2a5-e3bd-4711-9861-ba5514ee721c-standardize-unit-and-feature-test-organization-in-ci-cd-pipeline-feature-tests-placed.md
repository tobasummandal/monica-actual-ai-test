...
1. MUST: All feature tests MUST be placed in the tests/Feature directory for end-to-end scenario validation

## Policy Block

- MUST All feature tests MUST be placed in the tests/Feature directory for end-to-end scenario validation
