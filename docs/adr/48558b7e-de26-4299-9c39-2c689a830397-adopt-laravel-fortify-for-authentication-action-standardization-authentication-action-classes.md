# Adopt Laravel Fortify for Authentication Action Standardization: Authentication Action Classes
...
1. MUST_NOT: Authentication action classes MUST NOT contain presentation logic (views, redirects, session management) to maintain separation between authentication logic and deployment target concerns

## Policy Block

- MUST_NOT Authentication action classes MUST NOT contain presentation logic (views, redirects, session management) to maintain separation between authentication logic and deployment target concerns
