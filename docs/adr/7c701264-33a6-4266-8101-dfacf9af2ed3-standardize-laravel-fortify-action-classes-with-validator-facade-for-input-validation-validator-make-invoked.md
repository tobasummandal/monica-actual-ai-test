...
1. MUST: Validator::make() MUST be invoked before any data persistence or credential operations in Fortify action methods

## Policy Block

- MUST Validator::make() MUST be invoked before any data persistence or credential operations in Fortify action methods
