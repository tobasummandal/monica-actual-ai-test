...
1. MUST: Each migration MUST implement both up() and down() methods to support forward and backward schema evolution

## Policy Block

- MUST Each migration MUST implement both up() and down() methods to support forward and backward schema evolution
