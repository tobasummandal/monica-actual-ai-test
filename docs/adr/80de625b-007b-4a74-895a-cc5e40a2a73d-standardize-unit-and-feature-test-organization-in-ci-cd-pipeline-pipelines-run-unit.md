# Standardize Unit and Feature Test Organization in CI/CD Pipeline: Pipelines Run Unit
...
1. MAY: CI/CD pipelines MAY run unit and feature tests in parallel to optimize build time
