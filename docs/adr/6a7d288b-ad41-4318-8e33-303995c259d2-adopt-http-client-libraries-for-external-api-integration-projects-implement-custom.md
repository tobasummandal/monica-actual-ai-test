# Adopt HTTP Client Libraries for External API Integration: Projects Implement Custom
...
1. MAY: Projects MAY implement custom HTTP client wrappers for domain-specific requirements while maintaining the underlying library usage

## Policy Block

- MAY Projects MAY implement custom HTTP client wrappers for domain-specific requirements while maintaining the underlying library usage
