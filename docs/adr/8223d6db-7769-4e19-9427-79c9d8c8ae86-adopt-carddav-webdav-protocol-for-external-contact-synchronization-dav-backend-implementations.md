# Adopt CardDAV/WebDAV Protocol for External Contact Synchronization: Dav Backend Implementations
...
1. MUST: DAV backend implementations MUST implement the IDAVBackend interface to ensure consistent protocol handling

## Policy Block

- MUST DAV backend implementations MUST implement the IDAVBackend interface to ensure consistent protocol handling
