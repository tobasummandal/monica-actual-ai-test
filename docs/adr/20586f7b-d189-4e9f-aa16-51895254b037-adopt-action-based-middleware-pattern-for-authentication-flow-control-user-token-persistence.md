...
1. MUST: User token persistence MUST use Eloquent model methods (create, firstWhere) to store and retrieve OAuth provider associations with driver, driver_id, and user_id fields.

## Policy Block

- MUST User token persistence MUST use Eloquent model methods (create, firstWhere) to store and retrieve OAuth provider associations with driver, driver_id, and user_id fields.
