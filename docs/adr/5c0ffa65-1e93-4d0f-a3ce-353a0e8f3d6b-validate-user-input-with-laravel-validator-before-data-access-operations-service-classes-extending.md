...
1. MUST: Service classes extending BaseService MUST call validateRules() and implement custom validate() methods to verify account ownership and authorization before data access

## Policy Block

- MUST Service classes extending BaseService MUST call validateRules() and implement custom validate() methods to verify account ownership and authorization before data access
