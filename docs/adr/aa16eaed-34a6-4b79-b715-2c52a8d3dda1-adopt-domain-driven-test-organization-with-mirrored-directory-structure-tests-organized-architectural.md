...
1. SHOULD: Tests SHOULD be organized by architectural layer (Services, Controllers, ViewHelpers) within each domain to support layer-specific test execution

## Policy Block

- SHOULD Tests SHOULD be organized by architectural layer (Services, Controllers, ViewHelpers) within each domain to support layer-specific test execution
