# Adopt Inertia.js for Server-Driven Single Page Application Rendering: Data Passed Frontend
...
1. MUST: All data passed to the frontend MUST be serialized as props in the Inertia response, not through session flash data or view composers

## Policy Block

- MUST All data passed to the frontend MUST be serialized as props in the Inertia response, not through session flash data or view composers
