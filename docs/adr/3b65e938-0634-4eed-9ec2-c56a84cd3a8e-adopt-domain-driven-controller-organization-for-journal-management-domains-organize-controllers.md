...
1. MAY: Domains MAY organize controllers into further subdirectories if the number of controllers exceeds 10 within a single domain

## Policy Block

- MAY Domains MAY organize controllers into further subdirectories if the number of controllers exceeds 10 within a single domain
