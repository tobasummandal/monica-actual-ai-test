# Organize Domain Logic Using Domain-Driven Design Bounded Contexts: Service Classes Encapsulate
...
1. MUST: Service classes MUST encapsulate single business operations with clear, action-oriented names (e.g., RemoveContactFromPost, UpdateJournalMetric)

## Policy Block

- MUST Service classes MUST encapsulate single business operations with clear, action-oriented names (e.g., RemoveContactFromPost, UpdateJournalMetric)
