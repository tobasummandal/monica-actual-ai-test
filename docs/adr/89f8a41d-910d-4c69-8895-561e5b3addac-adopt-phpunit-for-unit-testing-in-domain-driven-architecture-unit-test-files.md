# Adopt PHPUnit for Unit Testing in Domain-Driven Architecture: Unit Test Files
...
1. MUST: Unit test files MUST be placed in tests/Unit/Domains/ directory structure mirroring the application domain hierarchy

## Policy Block

- MUST Unit test files MUST be placed in tests/Unit/Domains/ directory structure mirroring the application domain hierarchy
