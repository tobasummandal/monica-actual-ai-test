...
1. MUST: Validation MUST occur before any database operations, external API calls, or state-changing business logic

## Policy Block

- MUST Validation MUST occur before any database operations, external API calls, or state-changing business logic
