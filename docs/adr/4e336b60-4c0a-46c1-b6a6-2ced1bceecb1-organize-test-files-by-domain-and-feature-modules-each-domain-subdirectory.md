...
1. MUST: Each domain subdirectory MUST contain feature module subdirectories that mirror the production code organization (e.g., ManageTemplates, ManageUserPreferences, ManageUsers)

## Policy Block

- MUST Each domain subdirectory MUST contain feature module subdirectories that mirror the production code organization (e.g., ManageTemplates, ManageUserPreferences, ManageUsers)
