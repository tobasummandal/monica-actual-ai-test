...
1. MUST: All datastore interactions MUST use the application's configured primary database connection and MUST NOT hardcode connection strings

## Policy Block

- MUST All datastore interactions MUST use the application's configured primary database connection and MUST NOT hardcode connection strings
