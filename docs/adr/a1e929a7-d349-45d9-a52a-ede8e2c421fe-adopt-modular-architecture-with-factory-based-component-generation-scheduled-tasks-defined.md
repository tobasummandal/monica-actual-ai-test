...
1. MUST: Scheduled tasks MUST be defined in a centralized Schedule class that extends the framework's scheduling infrastructure

## Policy Block

- MUST Scheduled tasks MUST be defined in a centralized Schedule class that extends the framework's scheduling infrastructure
