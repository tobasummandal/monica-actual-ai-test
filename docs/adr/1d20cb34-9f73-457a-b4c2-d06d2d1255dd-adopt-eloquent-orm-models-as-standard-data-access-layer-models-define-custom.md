...
1. MAY: Models MAY define custom query scopes for reusable query logic specific to that entity

## Policy Block

- MAY Models MAY define custom query scopes for reusable query logic specific to that entity
