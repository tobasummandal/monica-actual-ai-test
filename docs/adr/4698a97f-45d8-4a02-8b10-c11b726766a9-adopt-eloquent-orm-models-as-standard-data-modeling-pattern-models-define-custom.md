# Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Models Define Custom
...
1. MAY: Models MAY define custom attributes using accessors and mutators for computed or transformed data
