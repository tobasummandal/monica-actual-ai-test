...
1. MUST: DAV/CalDAV/CardDAV protocol interactions MUST use Sabre DAV client libraries or equivalent standards-compliant implementations

## Policy Block

- MUST DAV/CalDAV/CardDAV protocol interactions MUST use Sabre DAV client libraries or equivalent standards-compliant implementations
