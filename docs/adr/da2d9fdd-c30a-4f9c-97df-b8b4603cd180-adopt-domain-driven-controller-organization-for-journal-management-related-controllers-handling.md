# Adopt Domain-Driven Controller Organization for Journal Management: Related Controllers Handling
...
1. SHOULD: Related controllers handling sub-resources SHOULD use composite naming that reflects the parent-child relationship (e.g., PostMetricController, PostSliceOfLifeController)

## Policy Block

- SHOULD Related controllers handling sub-resources SHOULD use composite naming that reflects the parent-child relationship (e.g., PostMetricController, PostSliceOfLifeController)
