...
1. SHOULD: DAV client services SHOULD be organized under dedicated DavClient namespace to separate external integration concerns from core domain logic

## Policy Block

- SHOULD DAV client services SHOULD be organized under dedicated DavClient namespace to separate external integration concerns from core domain logic
