...
1. SHOULD: Custom validation logic SHOULD use the after() callback method for complex validation scenarios like current password verification

## Policy Block

- SHOULD Custom validation logic SHOULD use the after() callback method for complex validation scenarios like current password verification
