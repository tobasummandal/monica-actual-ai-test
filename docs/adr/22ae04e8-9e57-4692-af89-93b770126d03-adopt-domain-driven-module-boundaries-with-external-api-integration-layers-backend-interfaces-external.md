...
1. MUST: Backend interfaces for external protocols MUST be defined as contracts (e.g., IDAVBackend) to enable multiple implementations and testing

## Policy Block

- MUST Backend interfaces for external protocols MUST be defined as contracts (e.g., IDAVBackend) to enable multiple implementations and testing
