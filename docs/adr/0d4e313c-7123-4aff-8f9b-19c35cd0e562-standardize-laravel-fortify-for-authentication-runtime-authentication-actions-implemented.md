...
1. MUST: Authentication actions MUST be implemented in the app/Actions/Fortify namespace following Fortify's action contract pattern

## Policy Block

- MUST Authentication actions MUST be implemented in the app/Actions/Fortify namespace following Fortify's action contract pattern
