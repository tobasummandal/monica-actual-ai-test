...
1. MUST_NOT: Core domain entities and business logic MUST NOT directly depend on external protocol implementation classes or libraries

## Policy Block

- MUST_NOT Core domain entities and business logic MUST NOT directly depend on external protocol implementation classes or libraries
