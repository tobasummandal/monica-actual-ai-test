...
1. SHOULD: Event payloads SHOULD follow a consistent structure with message and level properties to maintain predictable event handling

## Policy Block

- SHOULD Event payloads SHOULD follow a consistent structure with message and level properties to maintain predictable event handling
