# Adopt CardDAV/WebDAV Protocol for External Contact Synchronization: External Contact Synchronization
...
1. MUST: All external contact synchronization MUST use CardDAV/WebDAV protocols as the standard integration mechanism

## Policy Block

- MUST All external contact synchronization MUST use CardDAV/WebDAV protocols as the standard integration mechanism
