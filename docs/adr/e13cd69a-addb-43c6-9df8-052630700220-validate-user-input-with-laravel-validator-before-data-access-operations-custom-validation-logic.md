...
1. SHOULD: Custom validation logic SHOULD use after() callbacks for complex validation scenarios requiring access to existing model state

## Policy Block

- SHOULD Custom validation logic SHOULD use after() callbacks for complex validation scenarios requiring access to existing model state
