...
1. SHOULD: Data seeding operations within migrations SHOULD use DB facade for bulk inserts when populating reference tables

## Policy Block

- SHOULD Data seeding operations within migrations SHOULD use DB facade for bulk inserts when populating reference tables
