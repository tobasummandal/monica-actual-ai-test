...
1. SHOULD: Exception formatters SHOULD include contextual metadata (e.g., resource IDs, user context) when available without exposing sensitive information

## Policy Block

- SHOULD Exception formatters SHOULD include contextual metadata (e.g., resource IDs, user context) when available without exposing sensitive information
