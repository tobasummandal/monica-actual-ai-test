...
1. SHOULD: Controllers SHOULD use Inertia's lazy loading for expensive data that is not immediately needed on page load

## Policy Block

- SHOULD Controllers SHOULD use Inertia's lazy loading for expensive data that is not immediately needed on page load
