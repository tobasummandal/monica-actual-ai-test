...
1. MAY: Quality gates MAY be implemented as reusable validator classes or traits when validation logic is shared across multiple services

## Policy Block

- MAY Quality gates MAY be implemented as reusable validator classes or traits when validation logic is shared across multiple services
