...
1. SHOULD: The Hash facade configuration SHOULD use bcrypt or argon2id algorithms with framework-recommended work factors

## Policy Block

- SHOULD The Hash facade configuration SHOULD use bcrypt or argon2id algorithms with framework-recommended work factors
