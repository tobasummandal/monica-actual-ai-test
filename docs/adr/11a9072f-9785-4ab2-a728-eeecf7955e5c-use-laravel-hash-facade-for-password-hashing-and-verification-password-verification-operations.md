...
1. MUST: All password verification operations MUST use Hash::check() to perform constant-time comparison between plaintext input and stored hash

## Policy Block

- MUST All password verification operations MUST use Hash::check() to perform constant-time comparison between plaintext input and stored hash
