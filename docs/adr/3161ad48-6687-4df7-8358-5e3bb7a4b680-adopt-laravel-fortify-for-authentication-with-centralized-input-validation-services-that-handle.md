...
1. SHOULD: Services that handle user data SHOULD leverage validated data from Fortify Actions rather than implementing separate validation logic

## Policy Block

- SHOULD Services that handle user data SHOULD leverage validated data from Fortify Actions rather than implementing separate validation logic
