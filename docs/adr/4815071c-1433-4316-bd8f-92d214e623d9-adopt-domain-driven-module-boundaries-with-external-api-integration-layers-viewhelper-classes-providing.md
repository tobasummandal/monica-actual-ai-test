# Adopt Domain-Driven Module Boundaries with External API Integration Layers: Viewhelper Classes Providing
...
1. MUST: ViewHelper classes providing external API functionality MUST reside in Web/ViewHelpers directories within their respective domain modules

## Policy Block

- MUST ViewHelper classes providing external API functionality MUST reside in Web/ViewHelpers directories within their respective domain modules
