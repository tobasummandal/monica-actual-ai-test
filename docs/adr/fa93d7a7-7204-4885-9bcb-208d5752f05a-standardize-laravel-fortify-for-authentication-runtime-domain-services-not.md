# Standardize Laravel Fortify for Authentication Runtime: Domain Services Not
...
1. MUST_NOT: Domain services MUST NOT implement custom password hashing, validation, or authentication logic that bypasses Fortify

## Policy Block

- MUST_NOT Domain services MUST NOT implement custom password hashing, validation, or authentication logic that bypasses Fortify
