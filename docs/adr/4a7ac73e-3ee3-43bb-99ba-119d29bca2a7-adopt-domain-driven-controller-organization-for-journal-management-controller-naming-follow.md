# Adopt Domain-Driven Controller Organization for Journal Management: Controller Naming Follow
...
1. SHOULD: Controller naming SHOULD follow the pattern {Entity}Controller or {Entity}{Concern}Controller (e.g., JournalController, PostPhotoController)

## Policy Block

- SHOULD Controller naming SHOULD follow the pattern {Entity}Controller or {Entity}{Concern}Controller (e.g., JournalController, PostPhotoController)
