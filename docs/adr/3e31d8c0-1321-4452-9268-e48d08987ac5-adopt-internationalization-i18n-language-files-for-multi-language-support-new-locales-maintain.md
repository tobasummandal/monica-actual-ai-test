...
1. SHOULD: New locales SHOULD maintain structural parity with existing language files to ensure feature completeness across all supported languages

## Policy Block

- SHOULD New locales SHOULD maintain structural parity with existing language files to ensure feature completeness across all supported languages
