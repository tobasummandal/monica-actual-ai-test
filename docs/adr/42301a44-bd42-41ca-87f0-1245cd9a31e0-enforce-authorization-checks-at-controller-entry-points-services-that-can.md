# Enforce Authorization Checks at Controller Entry Points: Services That Can
...
1. SHOULD: Services that can be invoked from multiple entry points SHOULD implement their own authorization checks to ensure defense-in-depth

## Policy Block

- SHOULD Services that can be invoked from multiple entry points SHOULD implement their own authorization checks to ensure defense-in-depth
