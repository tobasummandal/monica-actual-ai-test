...
1. MUST: Protocol-specific operations MUST be abstracted behind interface contracts (e.g., IDAVBackend) to enable multiple implementations and improve testability

## Policy Block

- MUST Protocol-specific operations MUST be abstracted behind interface contracts (e.g., IDAVBackend) to enable multiple implementations and improve testability
