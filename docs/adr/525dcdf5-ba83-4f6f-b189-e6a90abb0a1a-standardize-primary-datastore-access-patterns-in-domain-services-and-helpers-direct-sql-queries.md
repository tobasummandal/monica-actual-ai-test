# Standardize Primary Datastore Access Patterns in Domain Services and Helpers: Direct Sql Queries
...
1. MUST: Direct SQL queries MUST NOT be used in domain services or view helpers unless explicitly justified and documented for performance reasons

## Policy Block

- MUST Direct SQL queries MUST NOT be used in domain services or view helpers unless explicitly justified and documented for performance reasons
