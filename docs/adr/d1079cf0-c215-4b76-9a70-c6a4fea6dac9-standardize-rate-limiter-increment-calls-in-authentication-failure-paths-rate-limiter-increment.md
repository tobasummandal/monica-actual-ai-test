...
1. MUST: Rate limiter increment calls MUST occur after firing authentication failure events and before exception propagation

## Policy Block

- MUST Rate limiter increment calls MUST occur after firing authentication failure events and before exception propagation
