# Adopt Domain-Driven Service Layer Architecture for Business Operations: Service Classes Encapsulate
...
1. SHOULD: Service classes SHOULD encapsulate a single business operation or use case to maintain single responsibility principle

## Policy Block

- SHOULD Service classes SHOULD encapsulate a single business operation or use case to maintain single responsibility principle
