# Adopt Internationalization (i18n) Language Files for Multi-Language Support: Translation Files Use
...
1. SHOULD: Translation files SHOULD use PHP array return structures for framework compatibility and easy key-value access

## Policy Block

- SHOULD Translation files SHOULD use PHP array return structures for framework compatibility and easy key-value access
