...
1. MUST: All Laravel Fortify action classes implementing authentication contracts MUST use Illuminate\Support\Facades\Validator for input validation

## Policy Block

- MUST All Laravel Fortify action classes implementing authentication contracts MUST use Illuminate\Support\Facades\Validator for input validation
