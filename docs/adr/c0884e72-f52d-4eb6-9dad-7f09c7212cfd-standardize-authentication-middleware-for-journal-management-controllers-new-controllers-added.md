...
1. MUST: New controllers added to the ManageJournals domain MUST follow the established authentication middleware pattern without deviation

## Policy Block

- MUST New controllers added to the ManageJournals domain MUST follow the established authentication middleware pattern without deviation
