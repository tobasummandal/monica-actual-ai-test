# Adopt PHP as Primary Backend Language for Laravel-Based Web Applications: Php Extensions Required
...
1. MUST: PHP extensions required by Laravel (OpenSSL, PDO, Mbstring, Tokenizer, XML, Ctype, JSON, BCMath) MUST be available in the deployment target

## Policy Block

- MUST PHP extensions required by Laravel (OpenSSL, PDO, Mbstring, Tokenizer, XML, Ctype, JSON, BCMath) MUST be available in the deployment target
