...
1. MUST: Authorization checks MUST validate user permissions against the specific resource being accessed, not just general role-based permissions

## Policy Block

- MUST Authorization checks MUST validate user permissions against the specific resource being accessed, not just general role-based permissions
