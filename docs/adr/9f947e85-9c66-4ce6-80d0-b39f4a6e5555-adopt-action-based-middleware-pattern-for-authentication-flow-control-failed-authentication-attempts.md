...
1. SHOULD: Failed authentication attempts SHOULD dispatch Illuminate\Auth\Events\Failed events and increment rate limiters before throwing ValidationException.

## Policy Block

- SHOULD Failed authentication attempts SHOULD dispatch Illuminate\Auth\Events\Failed events and increment rate limiters before throwing ValidationException.
