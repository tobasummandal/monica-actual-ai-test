...
1. MUST: All authentication middleware classes MUST inject a LoginRateLimiter or equivalent rate limiting service through constructor dependency injection

## Policy Block

- MUST All authentication middleware classes MUST inject a LoginRateLimiter or equivalent rate limiting service through constructor dependency injection
