...
1. MUST: Server-side rendering (SSR) MUST be implemented using a dedicated ssr.js entry point separate from the client-side app.js entry point

## Policy Block

- MUST Server-side rendering (SSR) MUST be implemented using a dedicated ssr.js entry point separate from the client-side app.js entry point
