...
1. MAY: CI/CD pipelines MAY leverage the domain-based directory structure to execute tests in parallel by domain or sub-domain

## Policy Block

- MAY CI/CD pipelines MAY leverage the domain-based directory structure to execute tests in parallel by domain or sub-domain
