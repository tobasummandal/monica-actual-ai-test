...
1. SHOULD: External API clients SHOULD implement compliance validation to detect and handle non-compliant external servers gracefully

## Policy Block

- SHOULD External API clients SHOULD implement compliance validation to detect and handle non-compliant external servers gracefully
