...
1. MUST: Rate limiter increment operations MUST occur after firing failed authentication events via event(new Failed(...))

## Policy Block

- MUST Rate limiter increment operations MUST occur after firing failed authentication events via event(new Failed(...))
