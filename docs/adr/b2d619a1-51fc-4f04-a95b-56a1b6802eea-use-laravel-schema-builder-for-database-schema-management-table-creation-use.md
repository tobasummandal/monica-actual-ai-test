...
1. MUST: Table creation MUST use Schema::create() with Blueprint closure defining column structure, constraints, and indexes

## Policy Block

- MUST Table creation MUST use Schema::create() with Blueprint closure defining column structure, constraints, and indexes
