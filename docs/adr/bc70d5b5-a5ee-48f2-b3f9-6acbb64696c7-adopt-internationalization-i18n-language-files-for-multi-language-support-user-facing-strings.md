...
1. MUST: All user-facing strings MUST be externalized into language-specific resource files organized under a lang/ directory structure

## Policy Block

- MUST All user-facing strings MUST be externalized into language-specific resource files organized under a lang/ directory structure
