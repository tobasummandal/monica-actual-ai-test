# Standardize Primary Datastore Access Patterns in Domain Services and Helpers: Domain Services View
...
1. MUST: All domain services, view helpers, and background jobs MUST access primary datastores through well-defined repository patterns or ORM abstractions (e.g., Eloquent models)

## Policy Block

- MUST All domain services, view helpers, and background jobs MUST access primary datastores through well-defined repository patterns or ORM abstractions (e.g., Eloquent models)
