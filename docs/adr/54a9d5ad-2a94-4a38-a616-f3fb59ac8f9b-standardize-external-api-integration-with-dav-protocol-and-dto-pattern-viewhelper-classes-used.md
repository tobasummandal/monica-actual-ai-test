...
1. SHOULD: ViewHelper classes SHOULD be used to prepare data for external API responses, separating presentation logic from business logic

## Policy Block

- SHOULD ViewHelper classes SHOULD be used to prepare data for external API responses, separating presentation logic from business logic
