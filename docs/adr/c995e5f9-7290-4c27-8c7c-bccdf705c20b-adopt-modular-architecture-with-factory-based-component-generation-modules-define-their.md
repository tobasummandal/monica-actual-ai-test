# Adopt Modular Architecture with Factory-Based Component Generation: Modules Define Their
...
1. MAY: Modules MAY define their own factory classes for complex nested structures (e.g., ModuleRow within Module)

## Policy Block

- MAY Modules MAY define their own factory classes for complex nested structures (e.g., ModuleRow within Module)
