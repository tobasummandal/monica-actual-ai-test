# Adopt HTTP Client Libraries for External API Integration: External Http Communications
...
1. MUST: All external HTTP API communications MUST use established HTTP client libraries rather than raw socket or curl implementations

## Policy Block

- MUST All external HTTP API communications MUST use established HTTP client libraries rather than raw socket or curl implementations
