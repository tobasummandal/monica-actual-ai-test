...
1. MAY: Models MAY define custom query scopes, accessors, and mutators for domain-specific data manipulation

## Policy Block

- MAY Models MAY define custom query scopes, accessors, and mutators for domain-specific data manipulation
