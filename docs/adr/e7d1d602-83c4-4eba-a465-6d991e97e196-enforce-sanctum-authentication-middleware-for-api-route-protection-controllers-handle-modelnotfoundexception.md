...
1. MUST: API controllers MUST handle ModelNotFoundException, QueryException, and ValidationException through centralized exception handling in the base controller

## Policy Block

- MUST API controllers MUST handle ModelNotFoundException, QueryException, and ValidationException through centralized exception handling in the base controller
