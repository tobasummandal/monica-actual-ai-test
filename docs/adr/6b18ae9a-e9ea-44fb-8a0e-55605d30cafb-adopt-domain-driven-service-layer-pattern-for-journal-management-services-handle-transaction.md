...
1. SHOULD: Services SHOULD handle transaction boundaries and data persistence concerns internally, exposing clean interfaces to controllers

## Policy Block

- SHOULD Services SHOULD handle transaction boundaries and data persistence concerns internally, exposing clean interfaces to controllers
