...
1. SHOULD: View helpers SHOULD retrieve data through service layer methods rather than directly querying datastores when business logic is involved

## Policy Block

- SHOULD View helpers SHOULD retrieve data through service layer methods rather than directly querying datastores when business logic is involved
