...
1. MUST_NOT: Plain-text passwords MUST NOT be stored in the database or logged in any application logs

## Policy Block

- MUST_NOT Plain-text passwords MUST NOT be stored in the database or logged in any application logs
