...
1. MUST: Each locale MUST provide translation files for core categories: auth, validation, passwords, actions, pagination, http-statuses, and format

## Policy Block

- MUST Each locale MUST provide translation files for core categories: auth, validation, passwords, actions, pagination, http-statuses, and format
