...
1. MUST: Password validation MUST use passwordRules() method and Hash::check() for current password verification before allowing password changes

## Policy Block

- MUST Password validation MUST use passwordRules() method and Hash::check() for current password verification before allowing password changes
