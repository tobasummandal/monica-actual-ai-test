...
1. MUST: All API routes serving protected resources MUST be wrapped in Route::middleware('auth:sanctum') to enforce token-based authentication

## Policy Block

- MUST All API routes serving protected resources MUST be wrapped in Route::middleware('auth:sanctum') to enforce token-based authentication
