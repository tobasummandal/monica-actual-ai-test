# Standardize Eloquent Models as Primary Data Access Layer with Public API Contracts: Models Use Explicit
...
1. SHOULD: Models SHOULD use explicit table name declarations via the $table property when the table name does not follow Laravel naming conventions

## Policy Block

- SHOULD Models SHOULD use explicit table name declarations via the $table property when the table name does not follow Laravel naming conventions
