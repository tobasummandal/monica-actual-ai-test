...
1. MUST: External DAV/CardDAV integrations MUST be encapsulated within domain-specific service layers (e.g., Contact domain DavClient services)

## Policy Block

- MUST External DAV/CardDAV integrations MUST be encapsulated within domain-specific service layers (e.g., Contact domain DavClient services)
