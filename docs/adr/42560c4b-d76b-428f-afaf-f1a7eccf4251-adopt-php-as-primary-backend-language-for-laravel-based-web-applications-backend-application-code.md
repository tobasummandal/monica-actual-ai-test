# Adopt PHP as Primary Backend Language for Laravel-Based Web Applications: Backend Application Code
...
1. MUST: All backend application code MUST be written in PHP to ensure consistent runtime environment and deployment target compatibility

## Policy Block

- MUST All backend application code MUST be written in PHP to ensure consistent runtime environment and deployment target compatibility
