...
1. SHOULD: Custom Fortify Actions SHOULD extend or implement Fortify's action contracts to maintain consistency with the framework

## Policy Block

- SHOULD Custom Fortify Actions SHOULD extend or implement Fortify's action contracts to maintain consistency with the framework
