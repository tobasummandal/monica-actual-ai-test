...
1. MAY: Components MAY subscribe to multiple events using separate emitter.on() registrations for different event types

## Policy Block

- MAY Components MAY subscribe to multiple events using separate emitter.on() registrations for different event types
