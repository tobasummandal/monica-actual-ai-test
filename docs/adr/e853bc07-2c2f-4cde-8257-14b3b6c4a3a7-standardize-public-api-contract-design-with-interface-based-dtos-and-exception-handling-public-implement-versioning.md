...
1. MAY: Public APIs MAY implement versioning strategies (URL path, header-based, or content negotiation) when backward compatibility cannot be maintained

## Policy Block

- MAY Public APIs MAY implement versioning strategies (URL path, header-based, or content negotiation) when backward compatibility cannot be maintained
