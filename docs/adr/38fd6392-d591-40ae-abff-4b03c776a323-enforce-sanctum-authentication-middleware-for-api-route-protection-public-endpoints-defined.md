...
1. MAY: Public API endpoints MAY be defined outside the auth:sanctum middleware group when explicitly designed for unauthenticated access

## Policy Block

- MAY Public API endpoints MAY be defined outside the auth:sanctum middleware group when explicitly designed for unauthenticated access
