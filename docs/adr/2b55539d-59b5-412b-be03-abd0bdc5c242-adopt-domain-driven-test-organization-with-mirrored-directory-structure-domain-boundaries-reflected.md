...
1. MUST: Domain boundaries MUST be reflected in the test directory structure, with tests organized under their respective domain and sub-domain directories

## Policy Block

- MUST Domain boundaries MUST be reflected in the test directory structure, with tests organized under their respective domain and sub-domain directories
