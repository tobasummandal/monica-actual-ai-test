...
1. MUST: JavaScript entry points (app.js, ssr.js) MUST be located in resources/js/ directory following Laravel's standard asset organization

## Policy Block

- MUST JavaScript entry points (app.js, ssr.js) MUST be located in resources/js/ directory following Laravel's standard asset organization
