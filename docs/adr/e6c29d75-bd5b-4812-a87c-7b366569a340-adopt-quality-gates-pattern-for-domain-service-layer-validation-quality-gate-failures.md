# Adopt Quality Gates Pattern for Domain Service Layer Validation: Quality Gate Failures
...
1. SHOULD: Quality gate failures SHOULD throw typed exceptions that clearly indicate the validation failure reason and affected data element

## Policy Block

- SHOULD Quality gate failures SHOULD throw typed exceptions that clearly indicate the validation failure reason and affected data element
