...
1. MUST: Test file names MUST follow the pattern {ClassName}Test.php, where {ClassName} is the exact name of the class under test

## Policy Block

- MUST Test file names MUST follow the pattern {ClassName}Test.php, where {ClassName} is the exact name of the class under test
