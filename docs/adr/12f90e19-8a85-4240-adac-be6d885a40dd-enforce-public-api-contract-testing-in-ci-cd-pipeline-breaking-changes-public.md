# Enforce Public API Contract Testing in CI/CD Pipeline: Breaking Changes Public
...
1. MUST: Breaking changes to public API contracts MUST cause CI/CD pipeline failures and prevent deployment

## Policy Block

- MUST Breaking changes to public API contracts MUST cause CI/CD pipeline failures and prevent deployment
