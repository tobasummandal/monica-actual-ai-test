# Adopt Eloquent ORM Models as Standard Data Access Layer: Model Specific Business
...
1. SHOULD: Model-specific business logic and computed attributes SHOULD be encapsulated within the model class using accessors, mutators, and custom methods

## Policy Block

- SHOULD Model-specific business logic and computed attributes SHOULD be encapsulated within the model class using accessors, mutators, and custom methods
