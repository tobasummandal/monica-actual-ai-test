...
1. SHOULD: Authentication configuration SHOULD be consistent across related resource controllers (e.g., Journal and JournalPhoto controllers)

## Policy Block

- SHOULD Authentication configuration SHOULD be consistent across related resource controllers (e.g., Journal and JournalPhoto controllers)
