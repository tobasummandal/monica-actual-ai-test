# Organize Domain Logic Using Domain-Driven Design Bounded Contexts: Controllers Delegate Business
...
1. SHOULD: Controllers SHOULD delegate business logic to service classes rather than implementing logic directly

## Policy Block

- SHOULD Controllers SHOULD delegate business logic to service classes rather than implementing logic directly
