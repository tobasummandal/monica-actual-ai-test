...
1. MUST: Authentication and security-critical operations (password reset, user management) MUST execute within the PHP runtime using Laravel's built-in security features

## Policy Block

- MUST Authentication and security-critical operations (password reset, user management) MUST execute within the PHP runtime using Laravel's built-in security features
