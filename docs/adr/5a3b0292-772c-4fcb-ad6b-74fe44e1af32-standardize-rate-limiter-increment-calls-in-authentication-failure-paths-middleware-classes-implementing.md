...
1. SHOULD: Middleware classes implementing authentication logic SHOULD follow the pattern: validateCredentials -> fireFailedEvent -> limiter->increment -> throwException

## Policy Block

- SHOULD Middleware classes implementing authentication logic SHOULD follow the pattern: validateCredentials -> fireFailedEvent -> limiter->increment -> throwException
