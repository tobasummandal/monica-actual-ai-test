...
1. MAY: Domain services MAY be reused across multiple controllers or other services when appropriate

## Policy Block

- MAY Domain services MAY be reused across multiple controllers or other services when appropriate
