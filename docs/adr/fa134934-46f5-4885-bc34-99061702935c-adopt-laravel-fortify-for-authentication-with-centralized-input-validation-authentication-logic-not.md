...
1. MUST_NOT: Authentication logic MUST NOT be duplicated outside of Fortify Actions

## Policy Block

- MUST_NOT Authentication logic MUST NOT be duplicated outside of Fortify Actions
