...
1. MUST: External API integrations MUST use Data Transfer Objects (DTOs) to represent external data structures and maintain clear boundaries between external formats and internal domain models

## Policy Block

- MUST External API integrations MUST use Data Transfer Objects (DTOs) to represent external data structures and maintain clear boundaries between external formats and internal domain models
