...
1. MUST: All secrets, credentials, and encryption keys used in CI/CD pipelines MUST be stored in encrypted form using a dedicated secrets management system

## Policy Block

- MUST All secrets, credentials, and encryption keys used in CI/CD pipelines MUST be stored in encrypted form using a dedicated secrets management system
