...
1. SHOULD: API and Web concerns SHOULD be separated into distinct test directories (Api/Controllers vs Web/ViewHelpers) to enable independent testing strategies

## Policy Block

- SHOULD API and Web concerns SHOULD be separated into distinct test directories (Api/Controllers vs Web/ViewHelpers) to enable independent testing strategies
