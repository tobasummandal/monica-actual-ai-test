...
1. MUST: Password update operations MUST validate the current password using Hash::check() before allowing password changes

## Policy Block

- MUST Password update operations MUST validate the current password using Hash::check() before allowing password changes
