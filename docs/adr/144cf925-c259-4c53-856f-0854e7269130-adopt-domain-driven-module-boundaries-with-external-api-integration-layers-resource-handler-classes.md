...
1. SHOULD: Resource handler classes (e.g., ImportResource, ImportVCardResource) SHOULD be used to manage external data import/export operations with clear single responsibilities

## Policy Block

- SHOULD Resource handler classes (e.g., ImportResource, ImportVCardResource) SHOULD be used to manage external data import/export operations with clear single responsibilities
