# Organize Test Files by Domain and Feature Modules: Pipelines Implement Domain
...
1. MAY: CI/CD pipelines MAY implement domain-specific test stages that execute only tests for changed domains

## Policy Block

- MAY CI/CD pipelines MAY implement domain-specific test stages that execute only tests for changed domains
