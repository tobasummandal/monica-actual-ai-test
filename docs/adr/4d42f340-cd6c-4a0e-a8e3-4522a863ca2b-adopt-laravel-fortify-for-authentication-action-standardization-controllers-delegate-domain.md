# Adopt Laravel Fortify for Authentication Action Standardization: Controllers Delegate Domain
...
1. MAY: Controllers MAY delegate to domain services or Fortify actions based on the complexity and domain-specificity of the operation

## Policy Block

- MAY Controllers MAY delegate to domain services or Fortify actions based on the complexity and domain-specificity of the operation
