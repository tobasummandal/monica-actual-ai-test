...
1. MUST: Fortify Actions MUST be registered and configured in FortifyServiceProvider

## Policy Block

- MUST Fortify Actions MUST be registered and configured in FortifyServiceProvider
