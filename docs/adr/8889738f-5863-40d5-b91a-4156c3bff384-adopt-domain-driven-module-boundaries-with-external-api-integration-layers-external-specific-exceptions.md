...
1. SHOULD: External API-specific exceptions SHOULD be defined within the integration module (e.g., DavServerNotCompliantException) to provide clear error boundaries

## Policy Block

- SHOULD External API-specific exceptions SHOULD be defined within the integration module (e.g., DavServerNotCompliantException) to provide clear error boundaries
