...
1. MUST: Each model MUST correspond to a single database table with the table name following Laravel's naming conventions (plural, snake_case)

## Policy Block

- MUST Each model MUST correspond to a single database table with the table name following Laravel's naming conventions (plural, snake_case)
