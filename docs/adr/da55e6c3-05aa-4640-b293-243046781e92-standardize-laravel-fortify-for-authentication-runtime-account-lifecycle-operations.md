# Standardize Laravel Fortify for Authentication Runtime: Account Lifecycle Operations
...
1. SHOULD: Account lifecycle operations (creation, cancellation, invitation acceptance) SHOULD integrate with Fortify's authentication context when user credentials are involved

## Policy Block

- SHOULD Account lifecycle operations (creation, cancellation, invitation acceptance) SHOULD integrate with Fortify's authentication context when user credentials are involved
