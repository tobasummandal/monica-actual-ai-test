...
1. MUST: Domain services MUST be organized by feature area (e.g., CreateAccount, CancelAccount, ManageUsers) to maintain clear boundaries

## Policy Block

- MUST Domain services MUST be organized by feature area (e.g., CreateAccount, CancelAccount, ManageUsers) to maintain clear boundaries
