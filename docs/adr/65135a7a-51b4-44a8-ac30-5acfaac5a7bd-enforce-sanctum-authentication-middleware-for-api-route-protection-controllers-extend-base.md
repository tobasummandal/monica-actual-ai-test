...
1. MUST: API controllers MUST extend a base ApiController that implements common middleware for request validation, pagination limits, and exception handling

## Policy Block

- MUST API controllers MUST extend a base ApiController that implements common middleware for request validation, pagination limits, and exception handling
