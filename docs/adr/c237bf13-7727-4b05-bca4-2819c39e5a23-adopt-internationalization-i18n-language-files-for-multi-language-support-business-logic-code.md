...
1. MUST_NOT: Business logic code MUST NOT contain hardcoded user-facing strings; all such strings MUST reference translation keys

## Policy Block

- MUST_NOT Business logic code MUST NOT contain hardcoded user-facing strings; all such strings MUST reference translation keys
