...
1. MUST: All user input arrays MUST be validated using Illuminate\Support\Facades\Validator::make() before any Eloquent data access operation (save, forceFill, update, create)

## Policy Block

- MUST All user input arrays MUST be validated using Illuminate\Support\Facades\Validator::make() before any Eloquent data access operation (save, forceFill, update, create)
