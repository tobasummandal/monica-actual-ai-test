...
1. SHOULD: Authorization logic SHOULD be centralized in reusable authorization service classes or middleware rather than duplicated across controllers

## Policy Block

- SHOULD Authorization logic SHOULD be centralized in reusable authorization service classes or middleware rather than duplicated across controllers
