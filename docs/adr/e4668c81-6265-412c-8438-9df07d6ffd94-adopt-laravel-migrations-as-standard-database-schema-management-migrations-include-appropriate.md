...
1. SHOULD: Migrations SHOULD include appropriate indexes, foreign key constraints, and default values as part of the schema definition

## Policy Block

- SHOULD Migrations SHOULD include appropriate indexes, foreign key constraints, and default values as part of the schema definition
