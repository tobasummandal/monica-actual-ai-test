# Adopt Eloquent ORM Models as Standard Data Modeling Pattern: Models Define Casts
...
1. SHOULD: Models SHOULD define casts for attributes that require type conversion (dates, JSON, booleans, etc.)

## Policy Block

- SHOULD Models SHOULD define casts for attributes that require type conversion (dates, JSON, booleans, etc.)
