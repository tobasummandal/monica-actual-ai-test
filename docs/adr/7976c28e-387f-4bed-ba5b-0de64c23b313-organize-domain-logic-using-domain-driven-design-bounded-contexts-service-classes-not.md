# Organize Domain Logic Using Domain-Driven Design Bounded Contexts: Service Classes Not
...
1. MUST_NOT: Service classes MUST NOT directly handle HTTP concerns such as request parsing or response formatting

## Policy Block

- MUST_NOT Service classes MUST NOT directly handle HTTP concerns such as request parsing or response formatting
