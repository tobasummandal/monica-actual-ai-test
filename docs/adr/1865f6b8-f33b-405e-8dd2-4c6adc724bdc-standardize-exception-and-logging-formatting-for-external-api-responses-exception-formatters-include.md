...
1. MUST: Exception formatters MUST include at minimum: error code, human-readable message, HTTP status code, and timestamp

## Policy Block

- MUST Exception formatters MUST include at minimum: error code, human-readable message, HTTP status code, and timestamp
