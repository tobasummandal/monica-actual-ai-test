# Use Laravel Hash Facade for Password Credential Storage: Applications Implement Automatic
...
1. MAY: Applications MAY implement automatic password rehashing on login if the configured algorithm or work factor changes

## Policy Block

- MAY Applications MAY implement automatic password rehashing on login if the configured algorithm or work factor changes
