...
1. MUST: Test file names MUST append 'Test' suffix to the corresponding production class name (e.g., RemoveModuleFromTemplatePage.php -> RemoveModuleFromTemplatePageTest.php)

## Policy Block

- MUST Test file names MUST append 'Test' suffix to the corresponding production class name (e.g., RemoveModuleFromTemplatePage.php -> RemoveModuleFromTemplatePageTest.php)
