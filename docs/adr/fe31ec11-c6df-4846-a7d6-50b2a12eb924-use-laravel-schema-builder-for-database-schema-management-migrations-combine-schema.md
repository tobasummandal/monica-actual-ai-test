...
1. MAY: Migrations MAY combine schema changes with data migrations when structural changes require corresponding data transformations

## Policy Block

- MAY Migrations MAY combine schema changes with data migrations when structural changes require corresponding data transformations
