...
1. SHOULD: Integration tests that verify real external service interactions SHOULD be separated from unit tests and run in dedicated CI/CD stages

## Policy Block

- SHOULD Integration tests that verify real external service interactions SHOULD be separated from unit tests and run in dedicated CI/CD stages
