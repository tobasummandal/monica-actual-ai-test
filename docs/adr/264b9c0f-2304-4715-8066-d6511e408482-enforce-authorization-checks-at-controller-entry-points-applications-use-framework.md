...
1. MAY: Applications MAY use framework-provided authorization middleware (e.g., Laravel policies, gates) to standardize enforcement patterns

## Policy Block

- MAY Applications MAY use framework-provided authorization middleware (e.g., Laravel policies, gates) to standardize enforcement patterns
