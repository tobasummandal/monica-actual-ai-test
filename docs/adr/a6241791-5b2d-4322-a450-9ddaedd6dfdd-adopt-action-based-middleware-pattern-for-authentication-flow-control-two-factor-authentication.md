...
1. MUST: Two-factor authentication detection MUST check both two_factor_secret/two_factor_confirmed_at fields and Webauthn::enabled() before proceeding with standard login flow.

## Policy Block

- MUST Two-factor authentication detection MUST check both two_factor_secret/two_factor_confirmed_at fields and Webauthn::enabled() before proceeding with standard login flow.
