# Organize Test Files by Domain and Feature Modules: Test Files Organized
...
1. MUST: Test files MUST be organized under tests/Unit/Domains/ following the same domain structure as production code

## Policy Block

- MUST Test files MUST be organized under tests/Unit/Domains/ following the same domain structure as production code
