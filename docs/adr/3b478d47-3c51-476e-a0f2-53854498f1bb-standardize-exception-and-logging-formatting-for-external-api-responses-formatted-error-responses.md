...
1. SHOULD: Formatted error responses SHOULD follow a standard JSON schema that is versioned and documented in API specifications

## Policy Block

- SHOULD Formatted error responses SHOULD follow a standard JSON schema that is versioned and documented in API specifications
