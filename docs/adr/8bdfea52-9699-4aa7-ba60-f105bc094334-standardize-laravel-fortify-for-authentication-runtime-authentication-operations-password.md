...
1. MUST: All authentication operations (password reset, password update, account creation) MUST use Laravel Fortify as the core authentication runtime library

## Policy Block

- MUST All authentication operations (password reset, password update, account creation) MUST use Laravel Fortify as the core authentication runtime library
