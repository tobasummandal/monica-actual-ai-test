...
1. SHOULD: ViewHelper classes SHOULD be used to prepare domain data for presentation layers without exposing internal domain logic

## Policy Block

- SHOULD ViewHelper classes SHOULD be used to prepare domain data for presentation layers without exposing internal domain logic
