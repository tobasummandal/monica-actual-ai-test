...
1. MUST: Unit tests MUST be organized under the tests/Unit/ directory with subdirectories reflecting the application structure (Models, Helpers, etc.)

## Policy Block

- MUST Unit tests MUST be organized under the tests/Unit/ directory with subdirectories reflecting the application structure (Models, Helpers, etc.)
