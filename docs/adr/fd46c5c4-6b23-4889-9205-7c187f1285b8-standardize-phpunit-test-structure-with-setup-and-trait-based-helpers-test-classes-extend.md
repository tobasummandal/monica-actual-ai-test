...
1. MUST: Test classes MUST extend PHPUnit\Framework\TestCase or an appropriate base test class

## Policy Block

- MUST Test classes MUST extend PHPUnit\Framework\TestCase or an appropriate base test class
