...
1. MUST: All domain entities that map to database tables MUST be represented as Eloquent Model classes extending Illuminate\Database\Eloquent\Model

## Policy Block

- MUST All domain entities that map to database tables MUST be represented as Eloquent Model classes extending Illuminate\Database\Eloquent\Model
