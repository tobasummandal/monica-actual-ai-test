...
1. MUST: Validation rules MUST be expressed as array structures passed to Validator::make() with field names as keys and rule arrays as values

## Policy Block

- MUST Validation rules MUST be expressed as array structures passed to Validator::make() with field names as keys and rule arrays as values
