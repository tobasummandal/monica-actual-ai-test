...
1. MUST: Custom middleware extending Inertia's base middleware MUST be placed in app/Http/Middleware/ and follow the naming convention Ensure[Feature][Condition].php
