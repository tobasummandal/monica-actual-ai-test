...
1. SHOULD: Action classes implementing Fortify contracts SHOULD use validateWithBag() to namespace validation errors for specific forms

## Policy Block

- SHOULD Action classes implementing Fortify contracts SHOULD use validateWithBag() to namespace validation errors for specific forms
