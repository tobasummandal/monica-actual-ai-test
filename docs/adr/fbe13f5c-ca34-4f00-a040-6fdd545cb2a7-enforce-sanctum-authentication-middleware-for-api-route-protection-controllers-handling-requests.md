...
1. SHOULD: Controllers handling API requests SHOULD be organized in domain-specific Api\Controllers namespaces to maintain clear service boundaries

## Policy Block

- SHOULD Controllers handling API requests SHOULD be organized in domain-specific Api\Controllers namespaces to maintain clear service boundaries
