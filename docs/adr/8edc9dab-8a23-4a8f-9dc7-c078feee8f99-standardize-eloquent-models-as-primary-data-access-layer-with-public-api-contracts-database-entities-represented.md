...
1. MUST: All database entities MUST be represented by Eloquent Model classes extending Illuminate\Database\Eloquent\Model

## Policy Block

- MUST All database entities MUST be represented by Eloquent Model classes extending Illuminate\Database\Eloquent\Model
