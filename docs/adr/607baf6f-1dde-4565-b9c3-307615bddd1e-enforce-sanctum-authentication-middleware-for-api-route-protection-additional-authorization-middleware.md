...
1. SHOULD: Additional authorization middleware using Laravel policies (can:policy-name) SHOULD be applied after authentication middleware for fine-grained access control

## Policy Block

- SHOULD Additional authorization middleware using Laravel policies (can:policy-name) SHOULD be applied after authentication middleware for fine-grained access control
