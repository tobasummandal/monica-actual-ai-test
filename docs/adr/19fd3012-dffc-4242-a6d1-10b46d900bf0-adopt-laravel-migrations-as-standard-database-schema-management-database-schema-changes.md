...
1. MUST: All database schema changes MUST be implemented using Laravel migration files stored in the database/migrations directory

## Policy Block

- MUST All database schema changes MUST be implemented using Laravel migration files stored in the database/migrations directory
