# Standardize Primary Datastore Access Patterns in Domain Services and Helpers: Data Access Logic
...
1. SHOULD: Data access logic SHOULD be encapsulated in dedicated repository classes or service methods rather than scattered across view helpers

## Policy Block

- SHOULD Data access logic SHOULD be encapsulated in dedicated repository classes or service methods rather than scattered across view helpers
